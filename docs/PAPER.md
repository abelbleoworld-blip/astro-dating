...
**Дмитриев А.А.** — научный сотрудник Государственной публичной научно-технической библиотеки России (ГПНТБ России).

Адрес для корреспонденции: turbo.a.turbo@gmail.com

## Благодарности

Работа выполнена в рамках исследовательской программы Abel Ecosystem Research. Вычислительная инфраструктура: MacBook Pro M1 Pro (координатор) + Beelink SER9 Windows (воркер) + VPS Timeweb Cloud (общее хранилище). Управление через A-Router оркестратор (Node.js Fastify + AMP Hub + Python agents).

Автор благодарит архитектурное решение mesh-оркестратора за возможность проведения параллельных независимых вычислений, обеспечивающих peer-review на уровне реализации.

## Декларация интересов

Конфликт интересов отсутствует. Все использованные данные открытые:
- Hipparcos Catalog (ESA 1997): https://www.cosmos.esa.int/web/hipparcos
- NASA Five Millennium Catalog of Solar Eclipses: https://eclipse.gsfc.nasa.gov/
- Ипатьевская летопись (ПСРЛ, т. 2, 1908) — открытые архивы

---

*Статья подготовлена 15 апреля 2026 года.*
